...
export function Navbar({ activeSection, onSectionChange }: NavbarProps) {
  ...
  return (
    <header className="sticky top-0 left-0 w-full z-50 flex items-center justify-between px-4 md:px-8 h-14 border-b border-border bg-background/80 backdrop-blur-sm">
